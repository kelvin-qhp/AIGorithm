...
if __name__ == '__main__':
    model = HMM(char2idx_path="../data/input/hmm_dict/char2idx.json",
                tag2idx_path="../data/input/hmm_dict/tag2idx.json")
    model.fit("./data/input/hmm_dict/train_data.txt")
    data_path = '../data/input/hmm_dict/emission.json.npy'
    # write_data(data_path,model.emission)
    # np.save(data_path,model.emission)
    read_data = np.load(data_path)

    model.predict("小明说新疆阿克苏苹果真好吃")